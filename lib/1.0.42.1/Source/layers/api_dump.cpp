...
inline void dump_vkGetPhysicalDeviceImageFormatProperties2KHX(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceImageFormatInfo2KHX* pImageFormatInfo, VkImageFormatProperties2KHX* pImageFormatProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceImageFormatProperties2KHX(dump_inst, result, physicalDevice, pImageFormatInfo, pImageFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceProperties2KHX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties2KHX* pProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceProperties2KHX(dump_inst, physicalDevice, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceImageFormatProperties2KHX(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceImageFormatInfo2KHX* pImageFormatInfo, VkImageFormatProperties2KHX* pImageFormatProperties)
{
    VkResult result = instance_dispatch_table(physicalDevice)->GetPhysicalDeviceImageFormatProperties2KHX(physicalDevice, pImageFormatInfo, pImageFormatProperties);
    dump_vkGetPhysicalDeviceImageFormatProperties2KHX(ApiDumpInstance::current(), result, physicalDevice, pImageFormatInfo, pImageFormatProperties);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceProperties2KHX(VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties2KHX* pProperties)
{
    instance_dispatch_table(physicalDevice)->GetPhysicalDeviceProperties2KHX(physicalDevice, pProperties);
    dump_vkGetPhysicalDeviceProperties2KHX(ApiDumpInstance::current(), physicalDevice, pProperties);
}
...
VK_LAYER_EXPORT VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetInstanceProcAddr(VkInstance instance, const char* pName)
{
    ...
    if(strcmp(pName, "vkGetPhysicalDeviceProperties2KHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetPhysicalDeviceProperties2KHX);
    ...
    if(strcmp(pName, "vkGetPhysicalDeviceImageFormatProperties2KHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetPhysicalDeviceImageFormatProperties2KHX);

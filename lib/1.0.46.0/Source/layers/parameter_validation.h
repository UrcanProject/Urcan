...
const uint32_t GeneratedHeaderVersion = 46;
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkDestroySurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroySurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroySurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSwapchainKHR*                             pSwapchain)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateSwapchainKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateSwapchainKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateSwapchainKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkDestroySwapchainKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroySwapchainKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroySwapchainKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkPresentInfoKHR*                     pPresentInfo)
{
    ...
    if (pPresentInfo != NULL)
    {
        ...
        skipCall |= validate_struct_pnext(report_data, "vkQueuePresentKHR", "pPresentInfo->pNext", "VkDisplayPresentInfoKHR, VkPresentRegionsKHR, VkDeviceGroupPresentInfoKHX, VkPresentTimesInfoGOOGLE", pPresentInfo->pNext, ARRAY_SIZE(allowedStructs), allowedStructs, GeneratedHeaderVersion);
    ...
    VkDisplayModeKHR*                           pMode)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateDisplayModeKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateDisplayModeKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateDisplayModeKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateDisplayPlaneSurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateDisplayPlaneSurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateDisplayPlaneSurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSwapchainKHR*                             pSwapchains)
{
    ...
    if (pCreateInfos != NULL)
    {
        for (uint32_t swapchainIndex = 0; swapchainIndex < swapchainCount; ++swapchainIndex)
        {
            ...
            skipCall |= validate_struct_pnext(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].pNext", ParameterName::IndexVector{ swapchainIndex }), "VkDeviceGroupSwapchainCreateInfoKHX", pCreateInfos[swapchainIndex].pNext, ARRAY_SIZE(allowedStructs), allowedStructs, GeneratedHeaderVersion);

            skipCall |= validate_flags(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].flags", ParameterName::IndexVector{ swapchainIndex }), "VkSwapchainCreateFlagBitsKHR", AllVkSwapchainCreateFlagBitsKHR, pCreateInfos[swapchainIndex].flags, false);

            skipCall |= validate_required_handle(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].surface", ParameterName::IndexVector{ swapchainIndex }), pCreateInfos[swapchainIndex].surface);

            skipCall |= validate_ranged_enum(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].imageFormat", ParameterName::IndexVector{ swapchainIndex }), "VkFormat", VK_FORMAT_BEGIN_RANGE, VK_FORMAT_END_RANGE, pCreateInfos[swapchainIndex].imageFormat);

            skipCall |= validate_ranged_enum(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].imageColorSpace", ParameterName::IndexVector{ swapchainIndex }), "VkColorSpaceKHR", VK_COLOR_SPACE_BEGIN_RANGE_KHR, VK_COLOR_SPACE_END_RANGE_KHR, pCreateInfos[swapchainIndex].imageColorSpace);

            skipCall |= validate_flags(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].imageUsage", ParameterName::IndexVector{ swapchainIndex }), "VkImageUsageFlagBits", AllVkImageUsageFlagBits, pCreateInfos[swapchainIndex].imageUsage, true);

            skipCall |= validate_ranged_enum(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].imageSharingMode", ParameterName::IndexVector{ swapchainIndex }), "VkSharingMode", VK_SHARING_MODE_BEGIN_RANGE, VK_SHARING_MODE_END_RANGE, pCreateInfos[swapchainIndex].imageSharingMode);

            skipCall |= validate_ranged_enum(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].presentMode", ParameterName::IndexVector{ swapchainIndex }), "VkPresentModeKHR", VK_PRESENT_MODE_BEGIN_RANGE_KHR, VK_PRESENT_MODE_END_RANGE_KHR, pCreateInfos[swapchainIndex].presentMode);

            skipCall |= validate_bool32(report_data, "vkCreateSharedSwapchainsKHR", ParameterName("pCreateInfos[%i].clipped", ParameterName::IndexVector{ swapchainIndex }), pCreateInfos[swapchainIndex].clipped);
        }
    }

    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateSharedSwapchainsKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateSharedSwapchainsKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateSharedSwapchainsKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateXlibSurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateXlibSurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateXlibSurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateXcbSurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateXcbSurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateXcbSurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateWaylandSurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateWaylandSurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateWaylandSurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateMirSurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateMirSurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateMirSurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateAndroidSurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateAndroidSurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateAndroidSurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateWin32SurfaceKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateWin32SurfaceKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateWin32SurfaceKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkWriteDescriptorSet*                 pDescriptorWrites)
{
    ...
    if (pDescriptorWrites != NULL)
    {
        for (uint32_t descriptorWriteIndex = 0; descriptorWriteIndex < descriptorWriteCount; ++descriptorWriteIndex)
        {
            skipCall |= validate_struct_pnext(report_data, "vkCmdPushDescriptorSetKHR", ParameterName("pDescriptorWrites[%i].pNext", ParameterName::IndexVector{ descriptorWriteIndex }), NULL, pDescriptorWrites[descriptorWriteIndex].pNext, 0, NULL, GeneratedHeaderVersion);

            skipCall |= validate_ranged_enum(report_data, "vkCmdPushDescriptorSetKHR", ParameterName("pDescriptorWrites[%i].descriptorType", ParameterName::IndexVector{ descriptorWriteIndex }), "VkDescriptorType", VK_DESCRIPTOR_TYPE_BEGIN_RANGE, VK_DESCRIPTOR_TYPE_END_RANGE, pDescriptorWrites[descriptorWriteIndex].descriptorType);
        }
    }
    ...
    VkDescriptorUpdateTemplateKHR*              pDescriptorUpdateTemplate)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateDescriptorUpdateTemplateKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateDescriptorUpdateTemplateKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateDescriptorUpdateTemplateKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkDestroyDescriptorUpdateTemplateKHR", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyDescriptorUpdateTemplateKHR", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyDescriptorUpdateTemplateKHR", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkDestroyDebugReportCallbackEXT", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyDebugReportCallbackEXT", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyDebugReportCallbackEXT", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateViSurfaceNN", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateViSurfaceNN", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateViSurfaceNN", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkIndirectCommandsLayoutNVX*                pIndirectCommandsLayout)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateIndirectCommandsLayoutNVX", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateIndirectCommandsLayoutNVX", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateIndirectCommandsLayoutNVX", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkDestroyIndirectCommandsLayoutNVX", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyIndirectCommandsLayoutNVX", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyIndirectCommandsLayoutNVX", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkObjectTableNVX*                           pObjectTable)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateObjectTableNVX", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateObjectTableNVX", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateObjectTableNVX", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkDestroyObjectTableNVX", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyObjectTableNVX", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkDestroyObjectTableNVX", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkFence*                                    pFence)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkRegisterDeviceEventEXT", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkRegisterDeviceEventEXT", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkRegisterDeviceEventEXT", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkFence*                                    pFence)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkRegisterDisplayEventEXT", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkRegisterDisplayEventEXT", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkRegisterDisplayEventEXT", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkRefreshCycleDurationGOOGLE*               pDisplayTimingProperties)
{
    ...
    skipCall |= validate_required_handle(report_data, "vkGetRefreshCycleDurationGOOGLE", "swapchain", swapchain);

    skipCall |= validate_required_pointer(report_data, "vkGetRefreshCycleDurationGOOGLE", "pDisplayTimingProperties", pDisplayTimingProperties);
    ...
    VkPastPresentationTimingGOOGLE*             pPresentationTimings)
{
    ...
    skipCall |= validate_required_handle(report_data, "vkGetPastPresentationTimingGOOGLE", "swapchain", swapchain);

    skipCall |= validate_array(report_data, "vkGetPastPresentationTimingGOOGLE", "pPresentationTimingCount", "pPresentationTimings", pPresentationTimingCount, pPresentationTimings, true, false, false);
    ...
    const VkHdrMetadataEXT*                     pMetadata)
{
    ...
    skipCall |= validate_handle_array(report_data, "vkSetHdrMetadataEXT", "swapchainCount", "pSwapchains", swapchainCount, pSwapchains, true, true);

    skipCall |= validate_struct_type_array(report_data, "vkSetHdrMetadataEXT", "swapchainCount", "pMetadata", "VK_STRUCTURE_TYPE_HDR_METADATA_EXT", swapchainCount, pMetadata, VK_STRUCTURE_TYPE_HDR_METADATA_EXT, true, true);

    if (pMetadata != NULL)
    {
        for (uint32_t swapchainIndex = 0; swapchainIndex < swapchainCount; ++swapchainIndex)
        {
            skipCall |= validate_struct_pnext(report_data, "vkSetHdrMetadataEXT", ParameterName("pMetadata[%i].pNext", ParameterName::IndexVector{ swapchainIndex }), NULL, pMetadata[swapchainIndex].pNext, 0, NULL, GeneratedHeaderVersion);
        }
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateIOSSurfaceMVK", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateIOSSurfaceMVK", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateIOSSurfaceMVK", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
    ...
    VkSurfaceKHR*                               pSurface)
{
    ...
    if (pAllocator != NULL)
    {
        skipCall |= validate_required_pointer(report_data, "vkCreateMacOSSurfaceMVK", "pAllocator->pfnAllocation", reinterpret_cast<const void*>(pAllocator->pfnAllocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateMacOSSurfaceMVK", "pAllocator->pfnReallocation", reinterpret_cast<const void*>(pAllocator->pfnReallocation));

        skipCall |= validate_required_pointer(report_data, "vkCreateMacOSSurfaceMVK", "pAllocator->pfnFree", reinterpret_cast<const void*>(pAllocator->pfnFree));
    }
